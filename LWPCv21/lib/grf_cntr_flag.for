...
c*******************!***************************************************
     ...
     &              words_to_cell
      ...
      integer, parameter :: mask(32) = [
     & int(z'80000000'),int(z'40000000'),int(z'20000000'),
     & int(z'10000000'),
     & int(z'08000000'),int(z'04000000'),int(z'02000000'),
     & int(z'01000000'),
     & int(z'00800000'),int(z'00400000'),int(z'00200000'),
     & int(z'00100000'),
     & int(z'00080000'),int(z'00040000'),int(z'00020000'),
     & int(z'00010000'),
     & int(z'00008000'),int(z'00004000'),int(z'00002000'),
     & int(z'00001000'),
     & int(z'00000800'),int(z'00000400'),int(z'00000200'),
     & int(z'00000100'),
     & int(z'00000080'),int(z'00000040'),int(z'00000020'),
     & int(z'00000010'),
     & int(z'00000008'),int(z'00000004'),int(z'00000002'),
     & int(z'00000001')]
